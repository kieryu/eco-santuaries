    <footer class="site-footer py-12 xl:py-20 bg-blackgray">
      <div class="inner flex flex-wrap xl:flex-nowrap">
        <div
          class="flex flex-wrap xl:flex-nowrap border-b basis-full mb-6 pb-6 pb-16 text-center border-white xl:pb-0 xl:text-left xl:pb-0 xl:mb-0 xl:basis-7/12 xl:border-r xl:border-b-0 ">
          <div class="logo basis-full xl:basis-3/12">
        ...
        <div class="flex flex-col basis-full xl:basis-5/12">
          <div class="flex flex-row items-center justify-center space-x-6 mt-6 mb-10 xl:justify-end">
            <a href="#" class="w-4">
    ...
    <script src="assets/libraries/jquery-3.6.1.min.js"></script>
    <script src="assets/libraries/slick/slick/slick.min.js"></script>
